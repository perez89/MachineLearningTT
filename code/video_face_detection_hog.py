...
while True:
    ...
    current_frame_to_detect_gray = cv2.cvtColor(current_frame_small, cv2.COLOR_BGR2GRAY)
    
    #detect all face locations using the HOB SVN classifier
    all_face_locations = face_detection_classifier(current_frame_to_detect_gray, 1)
